...
async function signUpService(
  ...
  try {
    ...
    const response = await axios.post(
      "https://0767pxkrva.execute-api.ap-south-1.amazonaws.com/latest/api/v1/user/signup",
      signUpObj
    );
    if (response) {
      setUser({
...
async function signInService(email, password, setUser, setEmail, setPassword) {
  ...
  try {
    const response = await axios.post(
      "https://0767pxkrva.execute-api.ap-south-1.amazonaws.com/latest/api/v1/user/signin",
      signInObj
    );
    if (response) {
      setUser({
